...
public native function <ClientConnector client> read (file:File file) (io:ByteChannel, FTPClientError);
...
@Return {value:"Error occured during FTP client invocation"}
public native function <ClientConnector client> copy (file:File source, file:File destination) (FTPClientError);
...
public native function <ClientConnector client> move (file:File target, file:File destination) (FTPClientError);

@Description {value:"Deletes a file from a given location"}
@Param {value:"target: File/Directory that should be deleted"}
@Return {value:"Error occured during FTP client invocation"}
public native function <ClientConnector client> delete (file:File target) (FTPClientError);
...
@Return {value:"Error occured during FTP client invocation"}
public native function <ClientConnector client> write (blob content, file:File file, string mode) (FTPClientError);
...
@Return {value:"Error occured during FTP client invocation"}
public native function <ClientConnector client> createFile (file:File file, boolean isDir) (FTPClientError);
...
public native function <ClientConnector client> exists (file:File file) (boolean, FTPClientError);
...
@Param {value:"mode: Whether to append or overwrite the given content ['append' | 'a' or 'overwrite' | 'o']"}
@Return {value:"Error occured during FTP client invocation"}
public native function <ClientConnector client> pipe (io:ByteChannel channel, file:File file, string mode) (FTPClientError);
