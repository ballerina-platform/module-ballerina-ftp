...
ftp:ListenerConfiguration secureRemoteServerConfig = {
    protocol: ftp:SFTP,
    host: "127.0.0.1",
    auth: {
        credentials: {
...
ftp:Service secureRemoteServerService = service object {
...
public function testConnectWithInvalidKey() returns error? {
    ftp:Listener sftpServer = check new ({
        protocol: ftp:SFTP,
        host: "localhost",
        port: 21213,
        auth: {
