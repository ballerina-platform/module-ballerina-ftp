...
function cleanupTestEnvironment() returns error? {
    if testClient is ftp:Client {
        check (<ftp:Client>testClient)->close();
    }
}
...
function uploadText(string remotePath, string localPath) returns error? {
    ...
    check (<ftp:Client>testClient)->put(remotePath, bStream);
}
...
public function testMultiPathRouting() returns error? {
    ...
    ftp:Listener tempRoutingListener = check new ({
        protocol: ftp:FTP,
        host: "127.0.0.1",
        auth: {credentials: {username: "wso2", password: "wso2123"}},
        port: 21212,
    ...
    ftp:Service routeAService = @ftp:ServiceConfig {path: SC_ROUTE_A_DIR}
    service object {
    ...
    ftp:Service routeBService = @ftp:ServiceConfig {path: SC_ROUTE_B_DIR}
    service object {
        remote function onFileText(string content, ftp:FileInfo fileInfo) returns error? {
...
public function testSingleServiceWithAnnotation() returns error? {
    ...
    ftp:Listener tempSingleListener = check new ({
        protocol: ftp:FTP,
        host: "127.0.0.1",
        auth: {credentials: {username: "wso2", password: "wso2123"}},
        port: 21212,
    ...
    ftp:Service singleService = @ftp:ServiceConfig {path: SC_SINGLE_DIR}
    service object {
        remote function onFileText(string content, ftp:FileInfo fileInfo) returns error? {
...
public function testBackwardCompatibility() returns error? {
    ...
    ftp:Service legacyService = service object {
        remote function onFileText(string content, ftp:FileInfo fileInfo) returns error? {
    ...
    ftp:Listener legacyListener = check new ({
        protocol: ftp:FTP,
        host: "127.0.0.1",
        auth: {credentials: {username: "wso2", password: "wso2123"}},
        port: 21212,
...
public function testMultipleServicesBackwardCompatible() returns error? {
    ...
    ftp:Service legacyService1 = service object {
        remote function onFileText(string content, ftp:FileInfo fileInfo) returns error? {
    ...
    ftp:Service legacyService2 = service object {
        remote function onFileText(string content, ftp:FileInfo fileInfo) returns error? {
    ...
    ftp:Listener fanOutListener = check new ({
        protocol: ftp:FTP,
        host: "127.0.0.1",
        auth: {credentials: {username: "wso2", password: "wso2123"}},
        port: 21212,
...
public function testDuplicatePathRegistrationError() returns error? {
    ...
    ftp:Service duplicateService1 = @ftp:ServiceConfig {path: "/home/in/duplicate-test"}
    service object {
        remote function onFileText(string content, ftp:FileInfo fileInfo) returns error? {
    ...
    ftp:Service duplicateService2 = @ftp:ServiceConfig {path: "/home/in/duplicate-test"}
    service object {
        remote function onFileText(string content, ftp:FileInfo fileInfo) returns error? {
    ...
    ftp:Listener duplicateListener = check new ({
        protocol: ftp:FTP,
        host: "127.0.0.1",
        auth: {credentials: {username: "wso2", password: "wso2123"}},
        port: 21212,
...
public function testMixedServicesError() returns error? {
    ...
    ftp:Service annotatedService = @ftp:ServiceConfig {path: "/home/in/mixed-test-annotated"}
    service object {
        remote function onFileText(string content, ftp:FileInfo fileInfo) returns error? {
    ...
    ftp:Service nonAnnotatedService = service object {
        remote function onFileText(string content, ftp:FileInfo fileInfo) returns error? {
            log:printInfo(string `[NonAnnotated] received: ${fileInfo.name}`);
        }
    };

    ftp:Listener mixedListener = check new ({
        protocol: ftp:FTP,
        host: "127.0.0.1",
        auth: {credentials: {username: "wso2", password: "wso2123"}},
        port: 21212,
    ...
    ftp:Listener mixedListener2 = check new ({
        protocol: ftp:FTP,
        host: "127.0.0.1",
        auth: {credentials: {username: "wso2", password: "wso2123"}},
        port: 21212,
...
public function testServiceConfigRecordStructure() {
    ...
    ftp:ServiceConfiguration fullConfig = {
        path: "/home/in/test",
        fileNamePattern: ".*\\.txt",
        fileAgeFilter: {
            minAge: 10.0,
...
public function testServiceConfigRecordDefaults() {
    ...
    ftp:ServiceConfiguration minConfig = {
...
public function testServiceConfigRelativePath() {
    ...
    ftp:ServiceConfiguration relativeConfig = {
        path: "relative/path"
    };
...
public function testServiceConfigInvalidFileNamePattern() returns error? {
    ...
    ftp:Listener ftpListener = check new (config);

    ftp:Service invalidRegexService = @ftp:ServiceConfig {
...
public function testServiceConfigInvalidTargetPattern() returns error? {
    ...
    ftp:Service invalidTargetService = @ftp:ServiceConfig {
...
public function testServiceConfigInvalidRequiredFilesPattern() returns error? {
    ...
    ftp:Service invalidRequiredService = @ftp:ServiceConfig {
