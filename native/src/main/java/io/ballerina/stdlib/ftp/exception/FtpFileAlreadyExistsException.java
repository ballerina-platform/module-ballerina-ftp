 ...
 */
public class FtpFileAlreadyExistsException extends RemoteFileSystemConnectorException implements ErrorTypeProvider {
    ...
    public String errorType() {
        return FtpUtil.ErrorType.FileAlreadyExistsError.errorType();
    }
}
